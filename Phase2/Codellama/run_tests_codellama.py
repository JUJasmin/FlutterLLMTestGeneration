...
if __name__ == "__main__":
  prompts = {
    "expandable": """You are a helpful assistant that writes Flutter widget tests using the `flutter_test` package.
...
""",
    "validation": """You are a helpful assistant that writes Flutter widget tests using the `flutter_test` package.
...
```
""",
    "pagination": """You are a helpful assistant that writes Flutter widget tests using the `flutter_test` package.
...
"""
  ...
  for tag, prompt in prompts.items():
    generate_test(prompt, f"output_codellama_fewshot_{tag}.txt")